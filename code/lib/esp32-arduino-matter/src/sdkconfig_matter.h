...
#define CONFIG_CUSTOM_DAC_PROVIDER 1
#define CONFIG_CUSTOM_COMMISSIONABLE_DATA_PROVIDER 1
#define CONFIG_CUSTOM_DEVICE_INSTANCE_INFO_PROVIDER 1
#define CONFIG_CUSTOM_DEVICE_INFO_PROVIDER 1
#define CONFIG_ESP_MATTER_MAX_DYNAMIC_ENDPOINT_COUNT 16
#define CONFIG_ESP_MATTER_SCENES_TABLE_SIZE 3
